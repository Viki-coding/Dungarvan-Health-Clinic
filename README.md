...
| ------------------ | -- | --------------------------------------------------------------------------- | ----------------------------------------------------------------------- | --------------------------------------- | ----------- |
| NAV                | 1  | Navigation link to Meet the Team                                            | Click on Meet the team link                                             | Meet the team page opens                | TRUE        |
|                    | 2  | Navigation link to Home                                                     | Click on Home link                                                      | Home page opens                         | TRUE        |
|                    | 3  | Navigation link to Call back Request                                        | Click on Request a Call Back Link                                       | Call Back page opens                    | TRUE        |
|                    | 4  | Navigation link to Home                                                     | Click on Home link                                                      | Home page opens                         | TRUE        |
| Home Page          | 5  | Phone number gets larger on hover                                           | Rest mouse over telephone - does it change?                             | Telephone number chages on mouse hover  | TRUE        |
|                    | 6  | Phone number is clickable link                                              | Click on phone number link                                              | Phone call process begins               | TRUE        |
| Call Back Request  | 7  | User can insert their first name                                            | Type in text                                                            | Text can be inserted                    | TRUE        |
|                    | 8  | User can insert their surname name                                          | Type in text                                                            | Text can be inserted                    | TRUE        |
|                    | 9  | User can insert their email  address                                        | Type in valid email address                                             | Email can be inserted                   | TRUE        |
|                    | 10 | User can insert their phone number                                          | Type in phone number                                                    | Phone number can be inserted            | TRUE        |
|                    | 11 | Submit button on hover enlarges                                             | Rest mouse over SUBMIT - does it change?                                | Submit button changes on mouse hover    | TRUE        |
|                    | 12 | When submit is click it takes you to 'thank you page                        | Click Submit and does it take you to new page named Thank you           | Thank you page opens                    | TRUE        |
|                    | 13 | Email without an @ should be get an error warning when submit is hit        | Insert text with no @ symbol, click sumit - is error message displayed  | Error message displayed                 | TRUE        |
|                    | 14 | First name ommitted should be get an error warning when submit is hit       | Omit text in first name field, click sumit - is error message displayed | Error message displayed                 | TRUE        |
|                    | 15 | Surname name ommitted should be get an error warning when submit is hit     | Omit text in surname field, click sumit - is error message displayed    | Error message displayed                 | TRUE        |
|                    | 16 | Email ommitted should be get an error warning when submit is hit            | Omit text in email  field, click sumit - is error message displayed     | Error message displayed                 | TRUE        |
|                    | 17 | Telephone number ommitted should be get an error warning when submit is hit | Omit text in telephone  field, click sumit - is error message displayed | Error message displayed                 | TRUE        |
|                    | 18 | Only 1 radion button can be chosen                                          | Click on various radio buttons                                          | Selected radio button                   | TRUE        |
| Thank you page     | 19 | Navigation to Home page                                                     | Click on 'HERE' to navigate back to Home Page                           | Returns user to Home page               | TRUE        |
| FOOTER             | 20 | Link in footer to facebook page in new page                                 | Click on link                                                           | Redirected to facebook page in new tab  | TRUE        |
|                    | 21 | Link in footer to instagram in new page                                     | Click on link                                                           | Redirected to instagram page in new tab | TRUE        |
|                    |    |                                                                             |                                                                         |                                         |             |
|                    |    |                                                                             |                                                                         |                                         |             |
| Spelling / Grammer | 22 | Home Page                                                                   | Text checked for spelling on ABC Webpage Spell-check                    | No incorrect spellings                  | TRUE        |
|                    | 23 | Meet the Team page                                                          | Text checked for spelling on ABC Webpage Spell-check                    | No incorrect spellings                  | TRUE        |
|                    | 24 | Request a Call Back                                                         | Text checked for spelling on ABC Webpage Spell-check                    | No incorrect spellings                  | TRUE        |
|                    | 25 | READ.me                                                                     | Text checked for spelling                                               | No incorrect spellings                  | TRUE        |
